...
const RULES: Rule[] = [
  {
    id: "unqualified-best",
    type: "superlative",
    pattern: /(#1|\b(best|number\s*one|top\s*rated|guaranteed|lowest\s*price|free)\b)/gi,
    severity: "high",
    whyRisky:
  ...
  },
  {
    ...
    pattern: /\b(save\s+\d+%|cheaper\s+than|lowest\s+cost|guaranteed\s+savings|save\s+money)\b/gi,
    severity: "high",
    whyRisky:
  ...
  },
  {
    ...
    pattern: /\blifetime\s+guarantee\b/gi,
    severity: "high",
    whyRisky:
