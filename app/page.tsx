    ...
    <main className="mx-auto grid min-h-screen w-[min(1200px,95vw)] gap-4 py-6">
      ...
      <Panel title="Input Mode">
        <p className="mb-3 text-sm text-slate-600">
          URL extraction is best-effort and may be blocked by access rules, robots policies, or terms. If that happens,
          switch to Upload HTML or Manual Entry.
        </p>
      ...
      {profile ? (
        <>
          ...
          <Panel title="Generate and Export">
            <div className="flex flex-wrap gap-2">
